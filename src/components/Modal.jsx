...
import coding from '../asset/Icons/coding.svg'

function Modal(props) {
	return (
		<>
			<div className='mx-10 relative'>
				<label for={props.index} class="w-64 btn min-h-[200px] bg-white text-slate-800 border-none hover:text-white hover:bg-gradient-to-r from-sky-500 to-indigo-500">{props.title}
				</label>
